...
# We also have to specify manually the SceneChecking cmake config files location,
# generated by the libsofa-core-devel ouput, which are not installed yet
# and are not located in standard locations
cmake ${CMAKE_ARGS} \
  -B . \
  -S ../applications/projects/runSofa/ \
  -DCMAKE_PREFIX_PATH="$CMAKE_PREFIX_PATH;$SRC_DIR/build/temp_prefix/plugins/SceneChecking/lib/cmake/SceneChecking" \
